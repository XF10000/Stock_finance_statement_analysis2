...
class HTMLReportGenerator:
    ...
    def generate_report(
        ...
        # 3. 现金流分析图表
        charts_config.extend(self._generate_cashflow_charts(cashflow_data, date_columns))
    ...
    def _generate_balance_charts(self, df: pd.DataFrame, date_columns: List[str]) -> List[Dict]:
        ...
        chart3 = {
            ...
            'colors': {
                '固定资产': self.COLORS['blue'],
                '固定资产合计': self.COLORS['blue'],  # 使用相同颜色
                '在建工程合计': self.COLORS['orange'],
                '工程物资': self.COLORS['gray'],
                '固定资产清理': self.COLORS['yellow'],
                '生产性生物资产': self.COLORS['green'],
                '公益性生物资产': self.COLORS['light_blue'],
                '油气资产': self.COLORS['brown'],
                '使用权资产': self.COLORS['dark_gray'],
                '无形资产': '#264478',
                '开发支出': '#9E480E',
                '商誉': '#636363',
                '长期待摊费用': '#997300',
    ...
    def _extract_chart_data(
        ...
        # 判断字段是否为比率字段（需要乘以100）
        ratio_fields = ['毛利率', '营业成本率', '销售费用率', '管理费用率', '研发费用率', 
    ...
    def _generate_html_template(self, charts_config: List[Dict], date_columns: List[str]) -> str:
        ...
        for chart in charts_config:
            if 'assets' in chart['id'] or 'capital' in chart['id'] or 'long_term' in chart['id'] or 'working_capital' in chart['id']:
            ...
            elif 'cashflow' in chart['id']:
                cashflow_charts.append(chart)
...
'''
        ...
        cashflow_containers = generate_section_charts(cashflow_charts)
...
<body>
    <div class="container">
        ...
        <div class="section">
            <h2 class="section-title">三、现金流分析</h2>
            {cashflow_containers}
        </div>
        
        <div class="section">
            <h2 class="section-title">四、经营效率分析</h2>
            {efficiency_containers}
        </div>
        
        <div class="section">
            <h2 class="section-title">五、财务成本分析</h2>
            {finance_cost_containers}
        </div>
        
        <div class="section">
            <h2 class="section-title">六、长期资产投资和并购活动分析</h2>
            {capex_containers}
        </div>
        
        <div class="section">
            <h2 class="section-title">七、投资收益分析</h2>
