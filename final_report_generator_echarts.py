...
class CoreIndicatorsReportGenerator:
    ...
    def __init__(self, db_path: str = 'database/All-A-Stock_financial_data.db'):
        ...
        self.indicators_config = [
            ...
            • <strong>长期经营资产（共 11 项）</strong> = 固定资产 + 在建工程 + 生产性生物资产 + 公益性生物资产 + 油气资产 + 使用权资产 + 无形资产 + 开发支出 + 商誉 + 长期待摊费用 + 其他非流动资产<br>
            • <em>若存在公司特定重分类规则，相关科目将按规则调整（例：000333.SZ 将「其他非流动资产」归入金融资产，从上述合计中剔除）</em><br>
            • TTM营业收入 = 最近四个季度的单季度营业收入之和<br>
